...
class ProductSearchForm(FormAction):
    ...
    def submit(
        ...
        if tracker.get_slot('category') == 'phone':
            ...
            df = pd.read_csv('./actions/files/phones_02.csv', encoding='latin1')
...
class ActionCheckWeather(Action):
    ...
    def run(self, dispatcher, tracker, domain):
        ...
        loc = ''
        cities = open('./actions/files/cities.txt','r', encoding="utf8")
        for city in cities:
...
class ActionCovidDetails(Action):
    ...
    def run(self, dispatcher, tracker, domain):
        ...
        message = message.lower()
        usr_country = ''
        country_file = open('./actions/files/countries.txt','r', encoding="utf8")
...
class ActionGoodbye(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher,
        ...
        df = pd.read_csv('./actions/files/usb_data.csv')
        text = 'Please find your searched items here.....\n'
...
class ActionGoodbye(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher,
        ...
        df = pd.read_csv('./actions/files/sd card data.csv')
        text = 'Please find your searched items here.....\n'
